...
import { PalletDocument } from "@/lib/pdf/PalletDocument";
...
export async function GET(
  ...
  const buffer = await renderToBuffer(<PalletDocument order={order} />);
  return new Response(new Uint8Array(buffer), {
    headers: {
      "Content-Type": "application/pdf",
      "Content-Disposition": `inline; filename="${order.zsplId}-pallet.pdf"`,
    },
  });
}
